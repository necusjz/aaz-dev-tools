from aazdev.command.model.configuration import CMDStringArgBase, CMDByteArgBase, CMDBinaryArgBase, CMDDurationArgBase, \
...
from aazdev.command.model.configuration import CMDArgGroup, CMDArgumentHelp
from aazdev.utils.case import to_camel_case, to_snack_case
