from aazdev.cli.model.atomic import CLIAtomicCommand
from aazdev.command.model.configuration import CMDCommand, CMDHttpOperation, CMDCondition, CMDConditionAndOperator, \
