...
def create_app():
    ...
    from aazdev.swagger.api import register_blueprints
    register_blueprints(app)

    # register routes of command module
    from aazdev.command.api import register_blueprints
    register_blueprints(app)

    # register routes of cli module
    from aazdev.cli.api import register_blueprints
    register_blueprints(app)

    from aazdev.document.api import register_blueprints
    register_blueprints(app)
