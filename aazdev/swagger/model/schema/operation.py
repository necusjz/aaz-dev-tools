...
from aazdev.command.model.configuration import CMDHttpOperation, CMDHttpAction, CMDHttpRequest, CMDHttpRequestPath, \
...
from aazdev.swagger.utils.tools import swagger_resource_path_to_resource_id_template
