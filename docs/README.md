...
- Argument:
  CLI user can pass in various types of arguments. In addition to the primitive types, users can also pass object, array and dict. For more information, please review [CLI/Argument](assets/cli/argument.md).
...
![CommandTreeNode](assets/images/aaz_command_tree_folder.png)
...
![CommandTreeLeaf](assets/images/aaz_command_tree_command_md.png)
...
![CommandConfiguration](assets/images/aaz_command_configuration.png)
...
![CommandConfigurationFileStructure](assets/diagrams/out/command_configuration/file_structure.svg)
...
![](assets/images/aaz-ci-failure.png)

When you click to view the details, you will see:
![](assets/images/aaz-ci-error-log.png)
...
![CommandModules](assets/images/az_cli_and_az_cli_extension_command_modules.png)
