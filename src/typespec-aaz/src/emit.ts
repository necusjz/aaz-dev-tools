...
// function emitHttpOperation(context: AAZOperationEmitterContext) {
//   const { path: fullPath, verb, parameters } = context.operation;
//   const opId = resolveOperationId(context, context.operation);
//   if (!context.pathItem[verb]) {
//     context.pathItem[verb] = {}
//   }

//   context.pathItem[verb]!.operationId = opId;
